import { members, taskTypes } from "../data/demo-data.js";
...
document.getElementById("preferenceList").innerHTML = taskTypes.map(task => `
  <div class="preference-row">
    ...
    <div class="preference-actions">
      <button data-preference="${task}:like">Liker</button>
      <button data-preference="${task}:can">Kan ta</button>
      <button data-preference="${task}:avoid">Helst ikke</button>
      <button data-preference="${task}:cannot">Kan ikke</button>
    </div>
  </div>
`).join("");
...
if (initialRoute && document.querySelector(`[data-page="${initialRoute}"]`)) {
