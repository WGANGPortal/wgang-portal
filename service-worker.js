const CACHE_NAME = "wgang-v0.18.0.74-immediate-derby-signup";
const APP_SHELL = [
  "/", "/index.html", "/privacy.html", "/rules.html", "/main.css?v=0.18.0.74",
  "/app.js?v=0.18.0.74", "/backend.js?v=0.18.0.74", "/config.js?v=0.18.0.60",
