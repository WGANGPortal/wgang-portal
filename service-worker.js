const CACHE_NAME = "wgang-v0.18.0.90-bingo-image-strategy";
const APP_SHELL = [
  "/", "/index.html", "/privacy.html", "/rules.html", "/main.css?v=0.18.0.90",
  "/app.js?v=0.18.0.90", "/backend.js?v=0.18.0.90", "/config.js?v=0.18.0.60",
