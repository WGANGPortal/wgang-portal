const CACHE_NAME = "wgang-v0.18.0.86-chat-images-mentions";
const APP_SHELL = [
  "/", "/index.html", "/privacy.html", "/rules.html", "/main.css?v=0.18.0.86",
  "/app.js?v=0.18.0.86", "/backend.js?v=0.18.0.86", "/config.js?v=0.18.0.60",
