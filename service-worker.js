const CACHE_NAME = "wgang-v0.18.0.85-edit-announcements";
const APP_SHELL = [
  "/", "/index.html", "/privacy.html", "/rules.html", "/main.css?v=0.18.0.85",
  "/app.js?v=0.18.0.85", "/backend.js?v=0.18.0.85", "/config.js?v=0.18.0.60",
