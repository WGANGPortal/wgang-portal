const CACHE_NAME = "wgang-v0.18.0.82-multi-game-identities";
const APP_SHELL = [
  "/", "/index.html", "/privacy.html", "/rules.html", "/main.css?v=0.18.0.82",
  "/app.js?v=0.18.0.82", "/backend.js?v=0.18.0.82", "/config.js?v=0.18.0.60",
