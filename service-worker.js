const CACHE_NAME = "wgang-v0.18.0.80-split-announcements-discussions";
const APP_SHELL = [
  "/", "/index.html", "/privacy.html", "/rules.html", "/main.css?v=0.18.0.80",
  "/app.js?v=0.18.0.80", "/backend.js?v=0.18.0.80", "/config.js?v=0.18.0.60",
