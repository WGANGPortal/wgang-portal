const CACHE_NAME = "wgang-v0.18.0.59-derby-rule-confirmation";
const APP_SHELL = [
  "/", "/index.html", "/privacy.html", "/rules.html", "/main.css?v=0.18.0.59",
  "/app.js?v=0.18.0.59", "/backend.js?v=0.18.0.59", "/config.js?v=0.18.0.59",
