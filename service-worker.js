const CACHE_NAME = "wgang-v0.18.0.79-neighborhood-news";
const APP_SHELL = [
  "/", "/index.html", "/privacy.html", "/rules.html", "/main.css?v=0.18.0.79",
  "/app.js?v=0.18.0.79", "/backend.js?v=0.18.0.79", "/config.js?v=0.18.0.60",
