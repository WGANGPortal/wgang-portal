const CACHE_NAME = "wgang-v0.18.0.87-bingo-planner";
const APP_SHELL = [
  "/", "/index.html", "/privacy.html", "/rules.html", "/main.css?v=0.18.0.87",
  "/app.js?v=0.18.0.87", "/backend.js?v=0.18.0.87", "/config.js?v=0.18.0.60",
