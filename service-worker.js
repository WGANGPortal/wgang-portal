const CACHE_NAME = "wgang-v0.18.0.73-security-least-privilege";
const APP_SHELL = [
  "/", "/index.html", "/privacy.html", "/rules.html", "/main.css?v=0.18.0.73",
  "/app.js?v=0.18.0.73", "/backend.js?v=0.18.0.73", "/config.js?v=0.18.0.60",
