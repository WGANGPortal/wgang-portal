const CACHE_NAME = "wgang-v0.18.0.56-rls-permissions";
const APP_SHELL = [
  "/", "/index.html", "/privacy.html", "/rules.html", "/main.css?v=0.18.0.56",
  "/app.js?v=0.18.0.56", "/backend.js?v=0.18.0.56", "/config.js?v=0.18.0.56",
