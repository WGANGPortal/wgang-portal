const CACHE_NAME = "wgang-v0.18.0.75-separate-current-next-derby";
const APP_SHELL = [
  "/", "/index.html", "/privacy.html", "/rules.html", "/main.css?v=0.18.0.75",
  "/app.js?v=0.18.0.75", "/backend.js?v=0.18.0.75", "/config.js?v=0.18.0.60",
