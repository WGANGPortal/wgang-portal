const CACHE_NAME = "wgang-v0.18.0.91-bingo-task-board";
const APP_SHELL = [
  "/", "/index.html", "/privacy.html", "/rules.html", "/main.css?v=0.18.0.91",
  "/app.js?v=0.18.0.91", "/backend.js?v=0.18.0.91", "/config.js?v=0.18.0.60",
