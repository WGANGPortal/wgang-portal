const CACHE_NAME = "wgang-v0.18.0.67-power-signup-completion";
const APP_SHELL = [
  "/", "/index.html", "/privacy.html", "/rules.html", "/main.css?v=0.18.0.67",
  "/app.js?v=0.18.0.67", "/backend.js?v=0.18.0.67", "/config.js?v=0.18.0.60",
